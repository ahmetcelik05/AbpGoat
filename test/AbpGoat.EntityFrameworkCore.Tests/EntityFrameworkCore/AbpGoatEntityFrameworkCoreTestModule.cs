...
public class AbpGoatEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new AbpGoatDbContext(new DbContextOptionsBuilder<AbpGoatDbContext>().UseSqlite(_database.ConnectionString).Options));
