...
public class AbpGoatEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<AbpGoatDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also AbpGoatDbContextFactory for EF Core tooling. */
