...
{
    [DbContext(typeof(AbpGoatDbContext))]
    [Migration("20260924115941_Add_Notes_Orders")]
    partial class Add_Notes_Orders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpGoat.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AbpGoat.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AbpGoat.Notes.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AbpGoat.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AbpGoat.Vulnerable.Documents.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AbpGoat.Vulnerable.Feedbacks.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AbpGoat.Books.Book", b =>
                {
                    b.HasOne("AbpGoat.Authors.Author", null)
                        .WithMany()
