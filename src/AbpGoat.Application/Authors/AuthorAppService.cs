...
[Authorize(AbpGoatPermissions.Authors.Default)]
public class AuthorAppService : ApplicationService, IAuthorAppService
{
    ...
    [Authorize(AbpGoatPermissions.Authors.Create)]
    ...
    [Authorize(AbpGoatPermissions.Authors.Edit)]
    ...
    [Authorize(AbpGoatPermissions.Authors.Delete)]
