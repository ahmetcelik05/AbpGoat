...
public class AbpGoatDbContext :
    AbpDbContext<AbpGoatDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public AbpGoatDbContext(DbContextOptions<AbpGoatDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AbpGoatConsts.DbTablePrefix + "Authors",
        ...
        {
            b.ToTable(AbpGoatConsts.DbTablePrefix + "Books",
                AbpGoatConsts.DbSchema);
            b.ConfigureByConvention(); //auto configure for the base class props
        ...
        {
            b.ToTable(AbpGoatConsts.DbTablePrefix + "Notes",
                AbpGoatConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Title).IsRequired().HasMaxLength(256);
        ...
        {
            b.ToTable(AbpGoatConsts.DbTablePrefix + "Orders",
                AbpGoatConsts.DbSchema);
            b.ConfigureByConvention();
        ...
        //{
        //    b.ToTable(AbpGoatConsts.DbTablePrefix + "YourEntities", AbpGoatConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
    }
