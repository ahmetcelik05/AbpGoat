...
[Authorize(AbpGoatPermissions.Books.Default)]
public class BookAppService : ApplicationService, IBookAppService
{
    ...
    [Authorize(AbpGoatPermissions.Books.Create)]
    ...
    [Authorize(AbpGoatPermissions.Books.Edit)]
    ...
    [Authorize(AbpGoatPermissions.Books.Delete)]
